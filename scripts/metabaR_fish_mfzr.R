...
#setwd("~/vtam_benchmark/obibar_fish/mfzr_obiout/")
###  import
...
#mblist <- tabfiles_to_metabarlist(file_reads = "out/obibar_fish/mfzr_obiout/reads_obi.tsv",
#                                    file_motus = "out/obibar_fish/mfzr_obiout/motus_obi_taxa2.tsv",
#                                    file_pcrs = "metafiles/pcrs_adapted_to_metabaR_fish_mfzr.tsv",
...
#setwd("~/vtam_benchmark/obibar_fish/mfzr_metabarout/")
...
#png(file="out/obibar_fish/mfzr_metabarout/relative_abundance_external_contaminants.png")
...
mblist$pcrs$nb_reads <- rowSums(mblist$reads)
mblist$pcrs$nb_motus <- rowSums(mblist$reads>0)
#png(file="out/obibar_fish/mfzr_metabarout/sequencing_depth.png")
...
#png(file="out/obibar_fish/mfzr_metabarout/pcr_slayer.png")
...
#png(file="out/obibar_fish/mfzr_metabarout/pcr_distances.png")
...
#png(file="out/obibar_fish/mfzr_metabarout/tagjumpslayer.png")
...
#write.csv2(reads_clean, file="out/obibar_fish/mfzr_metabarout/obibar_base.csv")
