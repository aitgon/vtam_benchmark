...
#setwd("~/vtam_benchmark/obibar_bat/obiout/")
###  import
#mblist <- tabfiles_to_metabarlist(file_reads = "reads_obi.tsv",
#                                    file_motus = "motus_obi_taxa2.tsv",
#                                    file_pcrs = "~/vtam_benchmark/metafiles/pcrs_adapted_to_metabaR_bat.tsv",
#                                    file_samples = "~/vtam_benchmark/metafiles/samples_wo_control_bat.tsv")

#mblist <- tabfiles_to_metabarlist(file_reads = "out/obibar_bat/obiout/reads_obi.tsv",
#                                    file_motus = "out/obibar_bat/obiout/motus_obi_taxa2.tsv",
#                                    file_pcrs = "metafiles/pcrs_adapted_to_metabaR_bat.tsv",
#                                    file_samples = "metafiles/samples_wo_control_bat.tsv")
...
#setwd("~/vtam_benchmark/obibar_bat/metabarout/")
...
#png(file="out/obibar_bat/metabarout/relative_abundance_external_contaminants.png")
...
mblist$pcrs$low_contamination_level <- ifelse(is.na(mblist$pcrs$low_contamination_level), FALSE, mblist$pcrs$low_contamination_level)
###
...
mblist$motus$target_taxon <- (grepl("Bacteria", mblist$motus$domain) | grepl("Archaea", mblist$motus$domain))
...
mblist$pcrs$nb_reads <- rowSums(mblist$reads)
mblist$pcrs$nb_motus <- rowSums(mblist$reads>0)
#png(file="out/obibar_bat/metabarout/sequencing_depth.png")
...
mblist$pcrs$seqdepth_ok <- ifelse(mblist$pcrs$nb_reads < 6e2, F, T)
...
#png(file="out/obibar_bat/metabarout/pcr_slayer.png")
...
#png(file="out/obibar_bat/metabarout/pcr_distances.png")
...
#png(file="out/obibar_bat/metabarout/tagjumpslayer.png")
...
#write.csv2(reads_clean, file="out/obibar_bat/metabarout/obibar_base.csv")
